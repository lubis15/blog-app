...
@section('container')
    ...
    <h1 class="mb-5 border-bottom pb-4 text-center mb-3"> {{ $title }} </h1>
        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div style="max-height: 400px; overflow:hidden;">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" class="card-img-top mt-4"
            ...
            <div class="card-body text-center">
                ...
                <small>
                    <p>By.<a class="text-decoration-none text-info" href="/posts?user={{ $posts[0]->user->username }}">
                            {{ $posts[0]->user->name }} </a> in <a
